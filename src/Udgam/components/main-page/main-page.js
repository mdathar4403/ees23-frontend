...
function UDGmain() {
  ...
  return (
    <div id="main-udgam" onClick={clicked}>
      ...
      <motion.div className="moving" key={counter} initial={{ x: '100vw' }} animate={{ x: '0vw' }} transition={{ duration: 3, ease: 'easeInOut' }} style={{ backgroundImage: `url(${arrimg[(counter + 1) % arrimg.length]})` }}>
