      ...
      {(slideNav || width > 800) && (
        <div className="udyam-nav">
          <div className="udyam-img">
            <Link to="/mashal" style={{ textDecoration: 'none' }}>
          ...
          <div className="udyam-icon">
            ...
            <div className="events hovered" id={props.active === '#event' ? 'active' : ''} onClick={events}>
              <Link to="/mashal/events" className="game-changer" style={{ textDecoration: 'none' }}>
            ...
            <div className="leaderboard hovered" id={props.active === '#leaderboard' ? 'active' : ''}>
              <Link to="/mashal/leaderboard" className="game-changer" style={{ textDecoration: 'none' }}>
          ...
          <div className="mashal_expanded_btn">
